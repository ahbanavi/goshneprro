...
## Requirements
You can use any [Laravel Pulse compatible database](https://laravel.com/docs/11.x/pulse#introduction), such as MySQL, MariaDB, or **PostgreSQL**, but for caching you need to use **Redis version 7.4.0** or higher. The reason is usage of `HEXPIRE` command in Redis which is available in Redis 7.4 and higher. [info](https://redis.io/docs/latest/commands/hexpire/)
